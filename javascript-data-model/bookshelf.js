...
console.log('The author of the book is:', bookshelf[1].author);
console.log('The ISBN of this book is:', bookshelf[0].isbn);
console.log('The title of the book is:', bookshelf[2].title);
